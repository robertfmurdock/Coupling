...
fun JsonSecretToken.toDomain(): Pair<Secret, String> = Secret(secretId, createdTimestamp) to secretToken
fun Pair<Secret, String>.toModel() = JsonSecretToken(first.id, first.createdTimestamp, second)
