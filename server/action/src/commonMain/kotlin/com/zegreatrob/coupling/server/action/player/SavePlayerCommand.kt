...
data class SavePlayerCommand(val player: Player) : SimpleSuspendResultAction<SavePlayerCommand.Dispatcher, Player> {
    override val performFunc = link(Dispatcher::perform)

    interface Dispatcher : PartyPlayerSaveSyntax, CurrentPartyIdSyntax {
