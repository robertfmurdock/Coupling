    ...
    sourceSets {
        getByName("commonMain") {
            dependencies {
                ...
                api("com.zegreatrob.testmints:action:3.1.14")
                api("com.zegreatrob.testmints:action-async:3.1.14")
        ...
        getByName("commonTest") {
            dependencies {
                ...
                implementation("com.zegreatrob.testmints:async:3.1.14")
                implementation("com.zegreatrob.testmints:minassert:3.1.14")
                implementation("com.zegreatrob.testmints:minspy:3.1.14")
