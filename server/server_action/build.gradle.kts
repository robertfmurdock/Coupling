    ...
    sourceSets {
        getByName("commonMain") {
            dependencies {
                ...
                api("com.zegreatrob.testmints:action:3.3.6")
                api("com.zegreatrob.testmints:action-async:3.3.6")
        ...
        getByName("commonTest") {
            dependencies {
                ...
                implementation("com.zegreatrob.testmints:async:3.3.6")
                implementation("com.zegreatrob.testmints:minassert:3.3.6")
                implementation("com.zegreatrob.testmints:minspy:3.3.6")
