    ...
    sourceSets {
        getByName("commonMain") {
            dependencies {
                ...
                api("com.zegreatrob.testmints:action:3.1.15")
                api("com.zegreatrob.testmints:action-async:3.1.15")
        ...
        getByName("commonTest") {
            dependencies {
                ...
                implementation("com.zegreatrob.testmints:async:3.1.15")
                implementation("com.zegreatrob.testmints:minassert:3.1.15")
                implementation("com.zegreatrob.testmints:minspy:3.1.15")
