    ...
    sourceSets {
        getByName("commonMain") {
            dependencies {
                ...
                api("com.zegreatrob.testmints:action:3.3.11")
                api("com.zegreatrob.testmints:action-async:3.3.11")
        ...
        getByName("commonTest") {
            dependencies {
                ...
                implementation("com.zegreatrob.testmints:async:3.3.11")
                implementation("com.zegreatrob.testmints:minassert:3.3.11")
                implementation("com.zegreatrob.testmints:minspy:3.3.11")
