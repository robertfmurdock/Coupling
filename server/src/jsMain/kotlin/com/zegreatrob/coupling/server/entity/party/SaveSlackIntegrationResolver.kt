...
val saveSlackIntegrationResolver = dispatch<JsonNull, SaveSlackIntegrationInput, CurrentPartyDispatcher, SaveSlackIntegrationCommand, VoidResult, Boolean?>(
    dispatcherFunc = requiredInput { request, _: JsonNull, args -> authorizedPartyDispatcher(request, args.partyId) },
    commandFunc = requiredInput { _, input: SaveSlackIntegrationInput -> input.toCommand() },
    fireFunc = ::perform,
