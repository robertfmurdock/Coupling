...
val deleteSecretResolver = dispatch(
    dispatcherFunc = requiredInput { request, _, args ->
        DispatcherProviders.authorizedPartyDispatcher(context = request, partyId = args.partyId)
    },
    commandFunc = requiredInput { _: JsonNull, args: GqlDeleteSecretInput -> args.toModel() },
    fireFunc = ::perform,
    toSerializable = { true },
)

fun GqlDeleteSecretInput.toModel() = DeleteSecretCommand(partyId, secretId)
