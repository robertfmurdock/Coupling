...
dependencies {
    ...
    implementation("com.zegreatrob.testmints:minreact:5.3.6")
    implementation("com.zegreatrob.testmints:react-data-loader:5.3.6")
    implementation("com.zegreatrob.testmints:action:5.3.6")
    implementation("com.zegreatrob.testmints:action-async:5.3.6")
    implementation("com.soywiz.korlibs.klock:klock:2.4.8")
    implementation("com.benasher44:uuid:0.3.1")
    implementation("org.jetbrains.kotlinx:kotlinx-serialization-core:1.3.1")
    implementation("org.jetbrains.kotlinx:kotlinx-html-js:0.7.3")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-extensions:1.0.1-pre.278-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-css:1.0.0-pre.278-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-styled:5.3.3-pre.278-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react:17.0.2-pre.278-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-dom:17.0.2-pre.278-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-router-dom:6.0.2-pre.278-kotlin-1.6.0")
