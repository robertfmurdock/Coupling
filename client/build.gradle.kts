...
dependencies {
    ...
    implementation("com.zegreatrob.testmints:minreact:3.2.0")
    ...
    testImplementation("com.zegreatrob.testmints:minenzyme:3.2.0")
    testImplementation("org.jetbrains.kotlin:kotlin-test-common")
    testImplementation("org.jetbrains.kotlin:kotlin-test-js")
    testImplementation("org.jetbrains.kotlin:kotlin-test-annotations-common")
    testImplementation("com.zegreatrob.testmints:standard:3.2.0")
    testImplementation("com.zegreatrob.testmints:async:3.2.0")
    testImplementation("com.zegreatrob.testmints:minassert:3.2.0")
    testImplementation("com.zegreatrob.testmints:minspy:3.2.0")
}
