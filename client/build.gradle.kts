...
dependencies {
    ...
    implementation("com.zegreatrob.testmints:minreact:4.0.4")
    implementation("com.zegreatrob.testmints:react-data-loader:4.0.4")
    implementation("com.zegreatrob.testmints:action:4.0.4")
    implementation("com.zegreatrob.testmints:action-async:4.0.4")
    ...
    testImplementation("com.zegreatrob.testmints:minenzyme:4.0.4")
    ...
    testImplementation("com.zegreatrob.testmints:minspy:4.0.4")
}
