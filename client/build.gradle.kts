...
dependencies {
    ...
    implementation("com.zegreatrob.testmints:minreact:5.2.2")
    implementation("com.zegreatrob.testmints:react-data-loader:5.2.2")
    ...
    implementation("org.jetbrains.kotlin-wrappers:kotlin-extensions:1.0.1-pre.272-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-css:1.0.0-pre.272-kotlin-1.6.0")
    ...
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-router-dom:6.0.2-pre.272-kotlin-1.6.0")
    ...
    testImplementation("com.zegreatrob.testmints:minenzyme:5.2.2")
    testImplementation("org.jetbrains.kotlin:kotlin-test-common")
    testImplementation("org.jetbrains.kotlin:kotlin-test-js")
    testImplementation("org.jetbrains.kotlin:kotlin-test-annotations-common")
    testImplementation("com.zegreatrob.testmints:standard:5.2.2")
    testImplementation("com.zegreatrob.testmints:async:5.2.2")
    testImplementation("com.zegreatrob.testmints:minassert:5.2.2")
    testImplementation("com.zegreatrob.testmints:minspy:5.2.2")
}
