...
dependencies {
    ...
    implementation("org.jetbrains:kotlin-extensions:1.0.1-pre.105-kotlin-1.3.72")
    implementation("org.jetbrains:kotlin-css:1.0.0-pre.105-kotlin-1.3.72")
    ...
    implementation("org.jetbrains:kotlin-react-router-dom:5.1.2-pre.105-kotlin-1.3.72")
