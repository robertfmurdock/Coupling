...
dependencies {
    ...
    implementation("com.zegreatrob.testmints:minreact:5.0.1")
    implementation("com.zegreatrob.testmints:react-data-loader:5.0.1")
    implementation("com.zegreatrob.testmints:action:5.0.1")
    implementation("com.zegreatrob.testmints:action-async:5.0.1")
    ...
    testImplementation("com.zegreatrob.testmints:minenzyme:5.0.1")
    testImplementation("org.jetbrains.kotlin:kotlin-test-common")
    testImplementation("org.jetbrains.kotlin:kotlin-test-js")
    testImplementation("org.jetbrains.kotlin:kotlin-test-annotations-common")
    testImplementation("com.zegreatrob.testmints:standard:5.0.1")
    testImplementation("com.zegreatrob.testmints:async:5.0.1")
    testImplementation("com.zegreatrob.testmints:minassert:5.0.1")
    testImplementation("com.zegreatrob.testmints:minspy:5.0.1")
}
