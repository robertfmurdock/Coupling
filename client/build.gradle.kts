...
dependencies {
    ...
    implementation("org.jetbrains.kotlin-wrappers:kotlin-css:1.0.0-pre.275-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-styled:5.3.3-pre.275-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react:17.0.2-pre.275-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-dom:17.0.2-pre.275-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-router-dom:6.0.2-pre.275-kotlin-1.6.0")
