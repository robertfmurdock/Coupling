...
dependencies {
    ...
    implementation("com.zegreatrob.testmints:minreact:5.3.8")
    implementation("com.zegreatrob.testmints:react-data-loader:5.3.8")
    implementation("com.zegreatrob.testmints:action:5.3.8")
    implementation("com.zegreatrob.testmints:action-async:5.3.8")
