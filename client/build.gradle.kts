...
dependencies {
    ...
    implementation("com.zegreatrob.testmints:minreact:3.1.7")
    implementation("com.zegreatrob.testmints:react-data-loader:3.1.7")
    implementation("com.zegreatrob.testmints:action:3.1.7")
    implementation("com.zegreatrob.testmints:action-async:3.1.7")
    ...
    implementation("org.jetbrains:kotlin-css:1.0.0-pre.111-kotlin-1.4.10")
    ...
    testImplementation("com.zegreatrob.testmints:minenzyme:3.1.7")
    ...
    testImplementation("com.zegreatrob.testmints:minspy:3.1.7")
}
