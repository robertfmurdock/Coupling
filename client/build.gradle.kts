...
dependencies {
    ...
    implementation("org.jetbrains.kotlin-wrappers:kotlin-extensions:1.0.1-pre.213-kotlin-1.6.0")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-css:1.0.0-pre.269-kotlin-1.6.0")
    ...
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-router-dom:6.0.2-pre.269-kotlin-1.6.0")
