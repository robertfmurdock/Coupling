...
data class RetiredPlayerQuery(val tribeId: TribeId, val playerId: String, val coupling: Coupling)

interface RetiredPlayerQueryDispatcher {
    suspend fun RetiredPlayerQuery.perform() = coupling.getData(tribeId)
            .let { (tribe, players) ->
