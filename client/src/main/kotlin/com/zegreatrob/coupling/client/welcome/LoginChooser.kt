...
data class LoginChooserProps(val commandFunc: CommandFunc<GoogleSignIn>) : RProps

private val styles = useStyles("LoginChooser")

val LoginChooser = reactFunction<LoginChooserProps> { (commandFunc) ->
    val googleSignInFunc = commandFunc { signIn() }
...
fun RBuilder.loginChooser(commandFunc: CommandFunc<GoogleSignIn>) =
