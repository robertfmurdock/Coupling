...
interface NewPairAssignmentsQueryDispatcher : ActionLoggingSyntax, TribeIdGetSyntax, GetPlayerListSyntax,
    ...
    private suspend fun TribeId.getData() = Pair(loadAsync(), getPlayerListAsync())
        .await()
