...
import com.zegreatrob.coupling.client.ServerMessageRenderer
...
class ServerMessageTest : ServerMessageRenderer {
    ...
    fun displaysServerMessage(): Unit = setup(object {
        ...
        val wrapper = shallowRender { serverMessage(props) }
