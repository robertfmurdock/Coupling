...
class WelcomeTest {
    ...
    @Test
    fun doesNotShowInitially() = setup(object : WelcomeBuilder {
    }) exercise {
        shallow(EmptyProps)
    } verify { wrapper ->
    ...
    fun willShowAfterZeroTimeoutSoThatAnimationWorks() = testAsync {
        withContext(coroutineContext) {
            setupAsync(object : WelcomeBuilder {
    ...
    @Test
    fun whenZeroIsRolledWillShowHobbits() = setup(object : WelcomeBuilder {
    ...
    @Test
    fun whenOneIsRolledWillShowTheDynamicDuo() = setup(object : WelcomeBuilder {
    ...
    @Test
    fun whenTwoIsRolledWillShowTheHeroesOfWWII() = setup(object : WelcomeBuilder {
