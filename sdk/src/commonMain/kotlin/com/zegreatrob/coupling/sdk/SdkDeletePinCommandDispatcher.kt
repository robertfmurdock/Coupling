...
import com.example.DeletePinMutation
import com.example.type.DeletePinInput
...
interface SdkDeletePinCommandDispatcher :
    ...
    override suspend fun perform(command: DeletePinCommand) = with(command) {
        (apolloMutation(DeletePinMutation(deletePinInput(command.partyId, pinId))).data?.deletePin ?: false)
            .voidResult()
    }
}
