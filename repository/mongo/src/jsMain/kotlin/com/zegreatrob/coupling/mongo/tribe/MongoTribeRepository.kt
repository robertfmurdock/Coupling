...
interface MongoTribeRepository : TribeRepository, DbRecordSaveSyntax, DbRecordLoadSyntax, DbRecordDeleteSyntax,
    ...
    private fun List<Record<Tribe>>.onlyLatestVersion() = groupBy { it.data.id }
    ...
    private fun Json.toTribe(): Tribe = Tribe(
        ...
        defaultBadgeName = this["defaultBadgeName"]?.toString() ?: defaultTribe.defaultBadgeName,
        alternateBadgeName = this["alternateBadgeName"]?.toString() ?: defaultTribe.alternateBadgeName,
