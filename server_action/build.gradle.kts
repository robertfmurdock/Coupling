    ...
    sourceSets {
        getByName("commonMain") {
            dependencies {
                ...
                api("com.zegreatrob.testmints:action:5.3.6")
                api("com.zegreatrob.testmints:action-async:5.3.6")
        ...
        getByName("commonTest") {
            dependencies {
                ...
                implementation("com.zegreatrob.testmints:async:5.3.6")
                implementation("com.zegreatrob.testmints:minassert:5.3.6")
                implementation("com.zegreatrob.testmints:minspy:5.3.6")
