...
angular.module('coupling.controllers').controller('NewPairAssignmentsController', ['$scope', '$location', 'Coupling', '$routeParams', 'tribe', 'players', function ($scope, $location, Coupling, $routeParams, tribe, players) {
    this.tribe = tribe;
    ...
    this.save = function () {
        Coupling.saveCurrentPairAssignments(tribe._id, controller.currentPairAssignments).then(function () {
...
}]).controller('CurrentPairAssignmentsController', ['pairAssignmentDocument', 'tribe', 'players', function (pairAssignmentDocument, tribe, players) {
    this.tribe = tribe;
