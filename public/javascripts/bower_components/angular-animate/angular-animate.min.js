            ...
            "$$asyncCallback", "$rootScope", "$document", function (t, s, aa, K, E, H, P) {
                ...
                function L(a, b, c) {
                    function d(a, b) {
                        ...
                        if (c || d)return"leave" == b && (d = c, c = null), A.push({event: b, fn: c}), l.push({event: b, fn: d}), !0
                    }
                    ...
                    if (e) {
                        ...
                        if (T(z)) {
                            ...
                            return{node: e, event: b, className: c, isClassBased: r, isSetClassOperation: h, before: function (a) {
                                v = a;
                                f(l, w, function () {
                                    v = m;
                                    a()
            ...
            "$$animateReflow", function (h, r, u, K) {
                ...
                function R(a, k) {
                    ...
                    if (!b) {
                        ...
                        b = {total: 0, transitionPropertyStyle: g, transitionDurationStyle: $, transitionDelayStyle: n, transitionDelay: d, transitionDuration: c, animationDelayStyle: Z, animationDelay: f, animationDuration: e};
                        k && (M[k] = b)
                    }
                    return b
                }
