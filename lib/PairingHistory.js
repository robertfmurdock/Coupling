var PairingHistory = function (historyDocumentsOldestToNewest) {

    var historyWithMostRecentFirst = historyDocumentsOldestToNewest.reverse();
    ...
    return {
        historyDocuments: historyDocumentsOldestToNewest,
