...
interface DynamoItemListGetSyntax : DynamoItemSyntax, DynamoDBSyntax, DynamoTableNameSyntax {
    ...
    private suspend fun fullList(scanParams: Json) = documentClient.scan(scanParams).promise().await()
        .itemsNode()
