...
dependencies {
    ...
    implementation(enforcedPlatform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:0.0.1-pre.326-kotlin-1.6.20"))
    implementation(enforcedPlatform("com.zegreatrob.testmints:testmints-bom:7.2.0"))
