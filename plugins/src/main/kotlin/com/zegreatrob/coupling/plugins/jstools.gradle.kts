...
dependencies {
    ...
    implementation(enforcedPlatform("com.zegreatrob.jsmints:jsmints-bom:1.6.21"))
    implementation(enforcedPlatform("io.ktor:ktor-bom:2.1.0"))
    implementation(enforcedPlatform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:1.0.0-pre.366"))
