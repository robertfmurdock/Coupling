...
dependencies {
    implementation(enforcedPlatform("com.zegreatrob.testmints:testmints-bom:8.1.2"))
    implementation(enforcedPlatform("com.zegreatrob.jsmints:jsmints-bom:1.6.17"))
    implementation(enforcedPlatform("io.ktor:ktor-bom:2.0.3"))
    implementation(enforcedPlatform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:1.0.0-pre.361"))
