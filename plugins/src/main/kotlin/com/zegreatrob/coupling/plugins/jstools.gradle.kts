...
dependencies {
    ...
    implementation(enforcedPlatform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:0.0.1-pre.283-kotlin-1.6.10"))
    implementation(enforcedPlatform("com.zegreatrob.testmints:testmints-bom:5.5.5"))
