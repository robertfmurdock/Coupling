...
dependencies {
    ...
    implementation(enforcedPlatform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:0.0.1-pre.324-kotlin-1.6.10"))
    implementation(enforcedPlatform("com.zegreatrob.testmints:testmints-bom:7.1.0"))
