...
dependencies {
    ...
    implementation(enforcedPlatform("com.zegreatrob.jsmints:jsmints-bom:1.6.14"))
    implementation(enforcedPlatform("io.ktor:ktor-bom:2.0.3"))
    implementation(enforcedPlatform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:1.0.0-pre.359"))
